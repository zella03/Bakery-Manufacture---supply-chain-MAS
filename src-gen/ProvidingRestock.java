  ...
  private class __Event1 {
    ...
    public void run() {
      if(ProvidingRestock.this.__ignoreMessageHandlers) {
       ...
       class __PatternMatcher1330716342 {
      	...
      	private final __PatternMatcher1330716342 __PatternMatcher1330716342_obj =  this;
      ...
      __PatternMatcher1330716342 __PatternMatcher1330716342_obj = new __PatternMatcher1330716342();
      jade.lang.acl.MessageTemplate __mt = jade.lang.acl.MessageTemplate.and(jade.lang.acl.MessageTemplate.and(jade.lang.acl.MessageTemplate.and(new jade.lang.acl.MessageTemplate(new jadescript.lang.acl.CustomMessageTemplate(((java.util.function.Predicate<jade.lang.acl.ACLMessage>) (__ignored) -> {{
      	...
      	try {
      		return __PatternMatcher1330716342_obj.headerMatch(__receivedMessage.getContent(_agentEnv.getAgent().getContentManager()));
      	}
      ...
      if(__receivedMessage != null) {
      	...
      	try {
      		try {
      			...
      			if(java.util.Objects.equals(__PatternMatcher1330716342_obj.stock.size(), 0)) {
      				/* 
      			...
      			for ( IngredientQuantity item : __PatternMatcher1330716342_obj.stock) {
      				/* 
      			...
      			if(!java.util.Objects.equals(ProvidingRestock.this.getItemsToProvide().size(), 0)) {
      				...
      				try {
      					...
      					java.lang.Object _contentToBeSent1671540946 = BakeryOntology.ProvideIngredients(ProvidingRestock.this.getItemsToProvide() ,__PatternMatcher1330716342_obj.whilePreparing);
      					
      					jadescript.core.message.Message _synthesizedMessage1671540946 = new jadescript.core.message.Message(jadescript.core.message.Message.REQUEST);
      					
      					_synthesizedMessage1671540946.setOntology(jadescript.util.SendMessageUtils.getDeclaringOntology(_contentToBeSent1671540946,BakeryOntology.getInstance(),BakeryOntology.getInstance()).getName());;
      					
      					_synthesizedMessage1671540946.setLanguage(__codec.getName());;
      					
      					_synthesizedMessage1671540946.addReceiver(senderAgent);
      					
      					_agentEnv.getAgent().getContentManager().fillContent(_synthesizedMessage1671540946, jadescript.content.onto.MessageContent.prepareContent((jade.content.ContentElement) _contentToBeSent1671540946, "request"));
      					
      					_agentEnv.getAgent().send(_synthesizedMessage1671540946);
      				}
