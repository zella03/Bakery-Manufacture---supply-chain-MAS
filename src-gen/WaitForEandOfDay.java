...
public class WaitForEandOfDay extends CyclicBehaviour<Supplier> {
  ...
  public WaitForEandOfDay(final AgentEnv<? extends Supplier, ? extends SideEffectsFlag.WithSideEffects> _agentEnv) {
    super(_agentEnv);
    __initializeAgentEnv();
    __initializeProperties();
  }

  public static WaitForEandOfDay __createEmpty(final AgentEnv<? extends Supplier, ? extends SideEffectsFlag.WithSideEffects> _agentEnv) {
    return new WaitForEandOfDay(_agentEnv);
  }
  ...
  private class __Event0 {
    ...
    public void run() {
      if(WaitForEandOfDay.this.__ignoreMessageHandlers) {
      ...
      if(__receivedMessage != null) {
      	WaitForEandOfDay.this.__ignoreMessageHandlers = true;
      	...
      	try {
      		try {
      			...
      			new ProvidingRestock(_agentEnv.getAgent().toEnv()).destroy();
      			...
      			new CurrentlyRestocking(_agentEnv.getAgent().toEnv()).destroy();
      			...
      			new GoForSupplies(_agentEnv.getAgent().toEnv()).destroy();
  ...
  private WaitForEandOfDay.__Event0 __event0 = null;

  private ExceptionThrower __thrower = jadescript.core.exception.ExceptionThrower.__DEFAULT_THROWER;

  public void __handleJadescriptException(final JadescriptException __exc) {
    jadescript.core.exception.ExceptionThrower __thrower = jadescript.core.exception.ExceptionThrower.__getExceptionEscalator(WaitForEandOfDay.this);
  ...
  private void __initializeProperties() {
    ...
    {
    	__event0 = new WaitForEandOfDay.__Event0();
    }
  }
}
