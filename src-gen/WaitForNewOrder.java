...
public class WaitForNewOrder extends CyclicBehaviour<Baker> {
  ...
  public Boolean checkIfKnow(final AgentEnv<? extends Baker, ? extends SideEffectsFlag.WithSideEffects> _agentEnv, final String good) {
    {
    	/* 
    	 * Compiled from source statement from line 205 to line 207
    	...
    	for ( Good item : WaitForNewOrder.this._agentEnv.getAgent().getRecipeBook()) {
    		/* 
    		 * Compiled from source statement from line 206 to line 207
    		 * if name of item = good do
    		 *                 return true
    		 */
  ...
  private class __Event2 {
    ...
    public void run() {
      if(WaitForNewOrder.this.__ignoreMessageHandlers) {
       ...
       class __PatternMatcher1014742528 {
      	public jade.core.AID agentId;
      	
      	public Order order;
      	
      	private final __PatternMatcher1014742528 __PatternMatcher1014742528_obj =  this;
      ...
      __PatternMatcher1014742528 __PatternMatcher1014742528_obj = new __PatternMatcher1014742528();
      jade.lang.acl.MessageTemplate __mt = jade.lang.acl.MessageTemplate.and(jade.lang.acl.MessageTemplate.and(jade.lang.acl.MessageTemplate.and(new jade.lang.acl.MessageTemplate(new jadescript.lang.acl.CustomMessageTemplate(((java.util.function.Predicate<jade.lang.acl.ACLMessage>) (__ignored) -> {{
      	...
      	try {
      		return __PatternMatcher1014742528_obj.headerMatch(__receivedMessage.getContent(_agentEnv.getAgent().getContentManager()));
      	}
      ...
      if(__receivedMessage != null) {
      	...
      	try {
      		try {
      			...
      			/* 
      			 * Compiled from source statement from line 216 to line 226
      			...
      			if(WaitForNewOrder.this.checkIfKnow(_agentEnv.getAgent().toEnv() ,__PatternMatcher1014742528_obj.order.getGood())) {
      				/* 
      				...
      				__PatternMatcher1014742528_obj.order.setStatus("toPrepare");
      				...
      				OrderStatus orderWithStatus = BakeryOntology.OrderStatus(__PatternMatcher1014742528_obj.order.getId() ,"toPrepare");
      				...
      				WaitForNewOrder.this._agentEnv.getAgent().getFullOrderList().add(__PatternMatcher1014742528_obj.order);
      				...
      				new PrepareOrder(_agentEnv.getAgent().toEnv() ,__PatternMatcher1014742528_obj.order).activate(_agentEnv.getAgent());
      			}
      			else {
      				/* 
